...
from modules.rnnlm2 import *
from rnnlm_wrapper import RNNLMWrapper
...
if __name__ == '__main__':
    ...
    train_data = prepare_dataset(train_raw_data)
    valid_data = prepare_dataset(valid_raw_data)
    test_data = prepare_dataset(test_raw_data)
    ...
    rnnlm = RNNLM(args).to(args.device)

    wrapper = RNNLMWrapper(rnnlm, args, wd_vocab)
    wrapper.summary()
